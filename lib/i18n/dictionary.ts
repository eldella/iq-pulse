  ...
  es: {
    ...
    stats: {
      performance: {
        ...
        heading: "Rendimiento",
        subhead: "Comparación de tu rendimiento con el promedio general de quienes hicieron el test.",
  ...
  en: {
    ...
    stats: {
      performance: {
        ...
        heading: "Performance",
        subhead: "How your performance compares to the general average across everyone who's taken the test.",
